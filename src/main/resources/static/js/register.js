document.getElementById("registerForm").addEventListener("submit", async function (e) {
    ...
    // Clear UI - removed "select" since it's no longer in the HTML
    ...
    // HARDCODED ROLE: No longer getting this from the UI
    ...
    // Validations (Removed the 'role' validation check)
